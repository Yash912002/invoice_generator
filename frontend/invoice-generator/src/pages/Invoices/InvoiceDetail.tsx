import { AlertCircleIcon, EditIcon, Loader2Icon, MailIcon, PrinterIcon } from 'lucide-react';
...
const InvoiceDetail = () => {
  ...
  if (!invoice) {
    return (
      <div className="flex flex-col justify-center items-center py-12 text-center bg-slate-50 rounded-lg">
  ...
  return (
    <>
      ...
      />
      <div
        className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 print:hidden"
      >
      ...
      <div id="invoice-content-wrapper">
        <div
          ...
          id='invoice-prview'
        >
          <div className="flex flex-col sm:flex-row justify-between items-start pb-8">
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 my-8">
            <div>
              <h3
                className="text-sm font-semibold text-slate-500 uppercase tracking-wideer mb-3"
              >
                Invoice Date
              </h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wideer mb-3">
                Due Date
              </h3>
              <p className="font-medium text-slate-800">
            ...
            <table className="w-full divide-y">
              <thead className="bg-slate-50">
                <tr>
                  ...
                  <th
                    className="px-4 sm:px-6 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider"
                  >
                    Qty
                  </th>
                  <th
                    className="px-4 sm:px-6 py-3 text-right text-xs font-medium text-slate-500 uppercase tracking-wider"
                  >
                    Price
                  </th>
                  <th
              ...
              <tbody className="bg-white divide-y divide-slate-200">
                {invoice.items.map((item, index) => (
                  <tr key={index}>
                    <td
                      className="px-4 sm:px-6 py-4 text-sm font-medium text-slate-900"
                    >
                      {item.name}
                    </td>
