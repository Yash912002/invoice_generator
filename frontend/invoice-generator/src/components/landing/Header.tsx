      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-8">
            <a
              href="#features"
              className="text-gray-600 hover:text-gray-900 font-medium transition-colors duration-200 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-black after:transition-all"
            >
              Features
            </a>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            {isAuthenticated ? (
              ...
              <>
                <Link to="/login" className="text-black hover:text-gray-900">
                  Login
                </Link>

                <Link
                  to="/signup"
                  className="bg-gradient-to-r from-blue-950 to-blue-900 text-white px-6 py-2 rounded-lg font-medium"
                >
                  Signup
                </Link>
              </>
